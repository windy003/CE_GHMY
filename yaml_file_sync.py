...
# 配置日志
log_dir = os.path.join(os.path.expanduser("~"), ".github_yaml_sync", "logs")
...
# 源文件路径
source_path = r"D:\files\using\CE_GHMY\github_repo_state.yaml"

    
# 目标路径
destination_path = 'gdrive:/sync/x13y-gen2/global_github_repos_yaml_sync/'
